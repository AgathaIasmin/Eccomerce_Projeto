...
// Função para configurar todos os event listeners da aplicação.
// Inclui listeners para busca, navegação por categorias, carrinho, autenticação, checkout, admin e fechar carrinho ao clicar fora.
...
// Recebe endpoint e opções de configuração.
// Adiciona headers padrão e token de autenticação se disponível.
// Faz fetch para a API, trata erros e retorna dados JSON.
